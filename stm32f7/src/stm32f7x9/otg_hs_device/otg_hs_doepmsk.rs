///Reader of register OTG_HS_DOEPMSK
pub type R = crate::R<u32, super::OTG_HS_DOEPMSK>;
///Writer for register OTG_HS_DOEPMSK
...
///Reader of field `OPEM`
pub type OPEM_R = crate::R<bool, bool>;
///Write proxy for field `OPEM`
pub struct OPEM_W<'a> {
    w: &'a mut W,
}
impl<'a> OPEM_W<'a> {
...
///Reader of field `BOIM`
pub type BOIM_R = crate::R<bool, bool>;
///Write proxy for field `BOIM`
pub struct BOIM_W<'a> {
    w: &'a mut W,
}
impl<'a> BOIM_W<'a> {
