///Reader of register OTG_HS_DVBUSDIS
pub type R = crate::R<u32, super::OTG_HS_DVBUSDIS>;
///Writer for register OTG_HS_DVBUSDIS
pub type W = crate::W<u32, super::OTG_HS_DVBUSDIS>;
///Register OTG_HS_DVBUSDIS `reset()`'s with value 0x17d7
impl crate::ResetValue for super::OTG_HS_DVBUSDIS {
    type Type = u32;
    #[inline(always)]
