///Reader of register OTG_HS_DIEPINT5
pub type R = crate::R<u32, super::OTG_HS_DIEPINT5>;
///Writer for register OTG_HS_DIEPINT5
pub type W = crate::W<u32, super::OTG_HS_DIEPINT5>;
///Register OTG_HS_DIEPINT5 `reset()`'s with value 0
impl crate::ResetValue for super::OTG_HS_DIEPINT5 {
    type Type = u32;
    #[inline(always)]
