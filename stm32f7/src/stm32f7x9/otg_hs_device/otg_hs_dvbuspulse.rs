///Reader of register OTG_HS_DVBUSPULSE
pub type R = crate::R<u32, super::OTG_HS_DVBUSPULSE>;
///Writer for register OTG_HS_DVBUSPULSE
pub type W = crate::W<u32, super::OTG_HS_DVBUSPULSE>;
///Register OTG_HS_DVBUSPULSE `reset()`'s with value 0x05b8
impl crate::ResetValue for super::OTG_HS_DVBUSPULSE {
    type Type = u32;
    #[inline(always)]
