///Reader of register OTG_HS_DCTL
pub type R = crate::R<u32, super::OTG_HS_DCTL>;
///Writer for register OTG_HS_DCTL
pub type W = crate::W<u32, super::OTG_HS_DCTL>;
///Register OTG_HS_DCTL `reset()`'s with value 0
impl crate::ResetValue for super::OTG_HS_DCTL {
    type Type = u32;
    #[inline(always)]
