///Reader of register OTG_HS_DOEPTSIZ0
pub type R = crate::R<u32, super::OTG_HS_DOEPTSIZ0>;
///Writer for register OTG_HS_DOEPTSIZ0
pub type W = crate::W<u32, super::OTG_HS_DOEPTSIZ0>;
///Register OTG_HS_DOEPTSIZ0 `reset()`'s with value 0
impl crate::ResetValue for super::OTG_HS_DOEPTSIZ0 {
    type Type = u32;
    #[inline(always)]
