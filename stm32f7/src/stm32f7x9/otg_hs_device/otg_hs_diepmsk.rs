///Reader of register OTG_HS_DIEPMSK
pub type R = crate::R<u32, super::OTG_HS_DIEPMSK>;
///Writer for register OTG_HS_DIEPMSK
pub type W = crate::W<u32, super::OTG_HS_DIEPMSK>;
///Register OTG_HS_DIEPMSK `reset()`'s with value 0
impl crate::ResetValue for super::OTG_HS_DIEPMSK {
    type Type = u32;
    #[inline(always)]
...
///Reader of field `TXFURM`
pub type TXFURM_R = crate::R<bool, bool>;
///Write proxy for field `TXFURM`
