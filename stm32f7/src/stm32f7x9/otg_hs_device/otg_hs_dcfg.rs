///Reader of register OTG_HS_DCFG
pub type R = crate::R<u32, super::OTG_HS_DCFG>;
///Writer for register OTG_HS_DCFG
pub type W = crate::W<u32, super::OTG_HS_DCFG>;
///Register OTG_HS_DCFG `reset()`'s with value 0x0220_0000
impl crate::ResetValue for super::OTG_HS_DCFG {
    type Type = u32;
    #[inline(always)]
...
///Reader of field `PERSCHIVL`
pub type PERSCHIVL_R = crate::R<u8, u8>;
///Write proxy for field `PERSCHIVL`
