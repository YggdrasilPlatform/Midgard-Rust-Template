...
///Write proxy for field `PLLSAIRDYC`
...
///Write proxy for field `PLLI2SRDYC`
...
///Write proxy for field `PLLSAIRDYIE`
...
///Reader of field `PLLI2SRDYIE`
pub type PLLI2SRDYIE_R = crate::R<bool, PLLSAIRDYIE_A>;
///Write proxy for field `PLLI2SRDYIE`
