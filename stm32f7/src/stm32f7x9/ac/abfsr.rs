///Reader of register ABFSR
pub type R = crate::R<u32, super::ABFSR>;
///Writer for register ABFSR
...
///Reader of field `ITCM`
pub type ITCM_R = crate::R<bool, bool>;
///Write proxy for field `ITCM`
pub struct ITCM_W<'a> {
    w: &'a mut W,
}
impl<'a> ITCM_W<'a> {
...
///Reader of field `DTCM`
pub type DTCM_R = crate::R<bool, bool>;
///Write proxy for field `DTCM`
pub struct DTCM_W<'a> {
    w: &'a mut W,
}
impl<'a> DTCM_W<'a> {
...
///Reader of field `AXIM`
pub type AXIM_R = crate::R<bool, bool>;
///Write proxy for field `AXIM`
pub struct AXIM_W<'a> {
    w: &'a mut W,
}
impl<'a> AXIM_W<'a> {
...
///Reader of field `EPPB`
pub type EPPB_R = crate::R<bool, bool>;
///Write proxy for field `EPPB`
pub struct EPPB_W<'a> {
    w: &'a mut W,
}
impl<'a> EPPB_W<'a> {
...
///Reader of field `AXIMTYPE`
pub type AXIMTYPE_R = crate::R<u8, u8>;
///Write proxy for field `AXIMTYPE`
