...
#[doc(hidden)]
pub struct _I2SCFGR;
///`read()` method returns [i2scfgr::R](i2scfgr::R) reader structure
impl crate::Readable for I2SCFGR {}
///`write(|w| ..)` method takes [i2scfgr::W](i2scfgr::W) writer structure
...
#[doc(hidden)]
pub struct _I2SPR;
///`read()` method returns [i2spr::R](i2spr::R) reader structure
impl crate::Readable for I2SPR {}
///`write(|w| ..)` method takes [i2spr::W](i2spr::W) writer structure
