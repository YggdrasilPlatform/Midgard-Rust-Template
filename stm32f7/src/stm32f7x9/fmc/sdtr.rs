///Reader of register SDTR%s
pub type R = crate::R<u32, super::SDTR>;
///Writer for register SDTR%s
...
///Reader of field `TMRD`
pub type TMRD_R = crate::R<u8, u8>;
///Write proxy for field `TMRD`
pub struct TMRD_W<'a> {
    w: &'a mut W,
}
impl<'a> TMRD_W<'a> {
...
///Reader of field `TXSR`
pub type TXSR_R = crate::R<u8, u8>;
///Write proxy for field `TXSR`
pub struct TXSR_W<'a> {
    w: &'a mut W,
}
impl<'a> TXSR_W<'a> {
...
///Reader of field `TRAS`
pub type TRAS_R = crate::R<u8, u8>;
///Write proxy for field `TRAS`
pub struct TRAS_W<'a> {
    w: &'a mut W,
}
impl<'a> TRAS_W<'a> {
...
///Reader of field `TRCD`
pub type TRCD_R = crate::R<u8, u8>;
///Write proxy for field `TRCD`
pub struct TRCD_W<'a> {
    w: &'a mut W,
}
impl<'a> TRCD_W<'a> {
