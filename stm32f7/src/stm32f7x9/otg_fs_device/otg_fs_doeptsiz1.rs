///Reader of register OTG_FS_DOEPTSIZ1
pub type R = crate::R<u32, super::OTG_FS_DOEPTSIZ1>;
///Writer for register OTG_FS_DOEPTSIZ1
pub type W = crate::W<u32, super::OTG_FS_DOEPTSIZ1>;
///Register OTG_FS_DOEPTSIZ1 `reset()`'s with value 0
impl crate::ResetValue for super::OTG_FS_DOEPTSIZ1 {
    type Type = u32;
    #[inline(always)]
