///Reader of register OTG_FS_DOEPCTL0
pub type R = crate::R<u32, super::OTG_FS_DOEPCTL0>;
///Writer for register OTG_FS_DOEPCTL0
pub type W = crate::W<u32, super::OTG_FS_DOEPCTL0>;
///Register OTG_FS_DOEPCTL0 `reset()`'s with value 0x8000
impl crate::ResetValue for super::OTG_FS_DOEPCTL0 {
    type Type = u32;
    #[inline(always)]
