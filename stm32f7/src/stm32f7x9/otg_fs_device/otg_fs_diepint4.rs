///Reader of register OTG_FS_DIEPINT4
pub type R = crate::R<u32, super::OTG_FS_DIEPINT4>;
///Writer for register OTG_FS_DIEPINT4
pub type W = crate::W<u32, super::OTG_FS_DIEPINT4>;
///Register OTG_FS_DIEPINT4 `reset()`'s with value 0
impl crate::ResetValue for super::OTG_FS_DIEPINT4 {
    type Type = u32;
    #[inline(always)]
