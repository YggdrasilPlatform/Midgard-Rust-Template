///Reader of register OTG_FS_DOEPMSK
pub type R = crate::R<u32, super::OTG_FS_DOEPMSK>;
///Writer for register OTG_FS_DOEPMSK
pub type W = crate::W<u32, super::OTG_FS_DOEPMSK>;
///Register OTG_FS_DOEPMSK `reset()`'s with value 0
impl crate::ResetValue for super::OTG_FS_DOEPMSK {
    type Type = u32;
    #[inline(always)]
