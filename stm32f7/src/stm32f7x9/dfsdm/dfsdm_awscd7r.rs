///Reader of register DFSDM_AWSCD7R
pub type R = crate::R<u32, super::DFSDM_AWSCD7R>;
///Writer for register DFSDM_AWSCD7R
pub type W = crate::W<u32, super::DFSDM_AWSCD7R>;
///Register DFSDM_AWSCD7R `reset()`'s with value 0
impl crate::ResetValue for super::DFSDM_AWSCD7R {
    type Type = u32;
    #[inline(always)]
