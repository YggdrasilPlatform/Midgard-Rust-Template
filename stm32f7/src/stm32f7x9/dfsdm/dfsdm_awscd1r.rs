///Reader of register DFSDM_AWSCD1R
pub type R = crate::R<u32, super::DFSDM_AWSCD1R>;
///Writer for register DFSDM_AWSCD1R
pub type W = crate::W<u32, super::DFSDM_AWSCD1R>;
///Register DFSDM_AWSCD1R `reset()`'s with value 0
impl crate::ResetValue for super::DFSDM_AWSCD1R {
    type Type = u32;
    #[inline(always)]
