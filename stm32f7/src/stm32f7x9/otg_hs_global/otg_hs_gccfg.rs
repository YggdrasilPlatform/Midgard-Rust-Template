///Reader of register OTG_HS_GCCFG
pub type R = crate::R<u32, super::OTG_HS_GCCFG>;
///Writer for register OTG_HS_GCCFG
...
///Reader of field `VBDEN`
pub type VBDEN_R = crate::R<bool, bool>;
///Write proxy for field `VBDEN`
