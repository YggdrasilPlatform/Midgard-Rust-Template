///Reader of register OTG_HS_HNPTXFSIZ_Host
pub type R = crate::R<u32, super::OTG_HS_HNPTXFSIZ_HOST>;
///Writer for register OTG_HS_HNPTXFSIZ_Host
pub type W = crate::W<u32, super::OTG_HS_HNPTXFSIZ_HOST>;
///Register OTG_HS_HNPTXFSIZ_Host `reset()`'s with value 0x0200
impl crate::ResetValue for super::OTG_HS_HNPTXFSIZ_HOST {
    type Type = u32;
    #[inline(always)]
