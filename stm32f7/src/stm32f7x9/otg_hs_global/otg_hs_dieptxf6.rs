///Reader of register OTG_HS_DIEPTXF6
pub type R = crate::R<u32, super::OTG_HS_DIEPTXF6>;
///Writer for register OTG_HS_DIEPTXF6
pub type W = crate::W<u32, super::OTG_HS_DIEPTXF6>;
///Register OTG_HS_DIEPTXF6 `reset()`'s with value 0x0200_0400
impl crate::ResetValue for super::OTG_HS_DIEPTXF6 {
    type Type = u32;
    #[inline(always)]
