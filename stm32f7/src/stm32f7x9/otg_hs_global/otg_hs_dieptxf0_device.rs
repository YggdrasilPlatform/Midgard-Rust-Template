///Reader of register OTG_HS_DIEPTXF0_Device
pub type R = crate::R<u32, super::OTG_HS_DIEPTXF0_DEVICE>;
///Writer for register OTG_HS_DIEPTXF0_Device
pub type W = crate::W<u32, super::OTG_HS_DIEPTXF0_DEVICE>;
///Register OTG_HS_DIEPTXF0_Device `reset()`'s with value 0x0200
impl crate::ResetValue for super::OTG_HS_DIEPTXF0_DEVICE {
    type Type = u32;
    #[inline(always)]
