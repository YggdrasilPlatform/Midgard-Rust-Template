///Reader of register OTG_FS_HCINTMSK3
pub type R = crate::R<u32, super::OTG_FS_HCINTMSK3>;
///Writer for register OTG_FS_HCINTMSK3
pub type W = crate::W<u32, super::OTG_FS_HCINTMSK3>;
///Register OTG_FS_HCINTMSK3 `reset()`'s with value 0
impl crate::ResetValue for super::OTG_FS_HCINTMSK3 {
    type Type = u32;
    #[inline(always)]
