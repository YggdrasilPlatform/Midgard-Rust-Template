///Reader of register OTG_FS_HCINTMSK8
pub type R = crate::R<u32, super::OTG_FS_HCINTMSK8>;
///Writer for register OTG_FS_HCINTMSK8
pub type W = crate::W<u32, super::OTG_FS_HCINTMSK8>;
///Register OTG_FS_HCINTMSK8 `reset()`'s with value 0
impl crate::ResetValue for super::OTG_FS_HCINTMSK8 {
    type Type = u32;
    #[inline(always)]
