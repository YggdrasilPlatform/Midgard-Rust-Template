///Reader of register OTG_FS_HCCHAR9
pub type R = crate::R<u32, super::OTG_FS_HCCHAR9>;
///Writer for register OTG_FS_HCCHAR9
pub type W = crate::W<u32, super::OTG_FS_HCCHAR9>;
///Register OTG_FS_HCCHAR9 `reset()`'s with value 0
impl crate::ResetValue for super::OTG_FS_HCCHAR9 {
    type Type = u32;
    #[inline(always)]
