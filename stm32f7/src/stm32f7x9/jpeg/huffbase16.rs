///Reader of register HUFFBASE16
pub type R = crate::R<u32, super::HUFFBASE16>;
///Writer for register HUFFBASE16
pub type W = crate::W<u32, super::HUFFBASE16>;
///Register HUFFBASE16 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFBASE16 {
    type Type = u32;
    #[inline(always)]
