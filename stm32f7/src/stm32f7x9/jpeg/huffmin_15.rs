///Reader of register HUFFMIN_15
pub type R = crate::R<u32, super::HUFFMIN_15>;
///Writer for register HUFFMIN_15
pub type W = crate::W<u32, super::HUFFMIN_15>;
///Register HUFFMIN_15 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFMIN_15 {
    type Type = u32;
    #[inline(always)]
