///Reader of register HUFFENC_AC0_7
pub type R = crate::R<u32, super::HUFFENC_AC0_7>;
///Writer for register HUFFENC_AC0_7
pub type W = crate::W<u32, super::HUFFENC_AC0_7>;
///Register HUFFENC_AC0_7 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFENC_AC0_7 {
    type Type = u32;
    #[inline(always)]
