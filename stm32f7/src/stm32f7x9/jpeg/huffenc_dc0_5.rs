///Reader of register HUFFENC_DC0_5
pub type R = crate::R<u32, super::HUFFENC_DC0_5>;
///Writer for register HUFFENC_DC0_5
pub type W = crate::W<u32, super::HUFFENC_DC0_5>;
///Register HUFFENC_DC0_5 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFENC_DC0_5 {
    type Type = u32;
    #[inline(always)]
