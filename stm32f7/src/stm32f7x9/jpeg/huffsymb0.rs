///Reader of register HUFFSYMB0
pub type R = crate::R<u32, super::HUFFSYMB0>;
///Writer for register HUFFSYMB0
pub type W = crate::W<u32, super::HUFFSYMB0>;
///Register HUFFSYMB0 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFSYMB0 {
    type Type = u32;
    #[inline(always)]
