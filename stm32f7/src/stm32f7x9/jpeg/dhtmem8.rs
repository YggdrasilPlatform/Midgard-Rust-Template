///Reader of register DHTMEM8
pub type R = crate::R<u32, super::DHTMEM8>;
///Writer for register DHTMEM8
pub type W = crate::W<u32, super::DHTMEM8>;
///Register DHTMEM8 `reset()`'s with value 0
impl crate::ResetValue for super::DHTMEM8 {
    type Type = u32;
    #[inline(always)]
