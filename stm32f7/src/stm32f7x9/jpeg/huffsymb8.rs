///Reader of register HUFFSYMB8
pub type R = crate::R<u32, super::HUFFSYMB8>;
///Writer for register HUFFSYMB8
pub type W = crate::W<u32, super::HUFFSYMB8>;
///Register HUFFSYMB8 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFSYMB8 {
    type Type = u32;
    #[inline(always)]
