///Reader of register HUFFBASE3
pub type R = crate::R<u32, super::HUFFBASE3>;
///Writer for register HUFFBASE3
pub type W = crate::W<u32, super::HUFFBASE3>;
///Register HUFFBASE3 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFBASE3 {
    type Type = u32;
    #[inline(always)]
