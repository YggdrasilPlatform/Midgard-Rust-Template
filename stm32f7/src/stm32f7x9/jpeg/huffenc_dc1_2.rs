///Reader of register HUFFENC_DC1_2
pub type R = crate::R<u32, super::HUFFENC_DC1_2>;
///Writer for register HUFFENC_DC1_2
pub type W = crate::W<u32, super::HUFFENC_DC1_2>;
///Register HUFFENC_DC1_2 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFENC_DC1_2 {
    type Type = u32;
    #[inline(always)]
