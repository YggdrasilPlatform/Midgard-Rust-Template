///Reader of register HUFFBASE10
pub type R = crate::R<u32, super::HUFFBASE10>;
///Writer for register HUFFBASE10
pub type W = crate::W<u32, super::HUFFBASE10>;
///Register HUFFBASE10 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFBASE10 {
    type Type = u32;
    #[inline(always)]
