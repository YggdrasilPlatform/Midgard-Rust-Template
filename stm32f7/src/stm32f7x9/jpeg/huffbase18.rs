///Reader of register HUFFBASE18
pub type R = crate::R<u32, super::HUFFBASE18>;
///Writer for register HUFFBASE18
pub type W = crate::W<u32, super::HUFFBASE18>;
///Register HUFFBASE18 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFBASE18 {
    type Type = u32;
    #[inline(always)]
