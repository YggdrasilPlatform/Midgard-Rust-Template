///Reader of register HUFFMIN_2
pub type R = crate::R<u32, super::HUFFMIN_2>;
///Writer for register HUFFMIN_2
pub type W = crate::W<u32, super::HUFFMIN_2>;
///Register HUFFMIN_2 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFMIN_2 {
    type Type = u32;
    #[inline(always)]
