///Reader of register DHTMEM4
pub type R = crate::R<u32, super::DHTMEM4>;
///Writer for register DHTMEM4
pub type W = crate::W<u32, super::DHTMEM4>;
///Register DHTMEM4 `reset()`'s with value 0
impl crate::ResetValue for super::DHTMEM4 {
    type Type = u32;
    #[inline(always)]
