///Reader of register HUFFSYMB1
pub type R = crate::R<u32, super::HUFFSYMB1>;
///Writer for register HUFFSYMB1
pub type W = crate::W<u32, super::HUFFSYMB1>;
///Register HUFFSYMB1 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFSYMB1 {
    type Type = u32;
    #[inline(always)]
