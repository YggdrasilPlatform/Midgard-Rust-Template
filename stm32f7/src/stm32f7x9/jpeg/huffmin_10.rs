///Reader of register HUFFMIN_10
pub type R = crate::R<u32, super::HUFFMIN_10>;
///Writer for register HUFFMIN_10
pub type W = crate::W<u32, super::HUFFMIN_10>;
///Register HUFFMIN_10 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFMIN_10 {
    type Type = u32;
    #[inline(always)]
