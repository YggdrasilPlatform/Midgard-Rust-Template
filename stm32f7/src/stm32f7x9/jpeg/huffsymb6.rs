///Reader of register HUFFSYMB6
pub type R = crate::R<u32, super::HUFFSYMB6>;
///Writer for register HUFFSYMB6
pub type W = crate::W<u32, super::HUFFSYMB6>;
///Register HUFFSYMB6 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFSYMB6 {
    type Type = u32;
    #[inline(always)]
