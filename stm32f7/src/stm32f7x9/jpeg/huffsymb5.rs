///Reader of register HUFFSYMB5
pub type R = crate::R<u32, super::HUFFSYMB5>;
///Writer for register HUFFSYMB5
pub type W = crate::W<u32, super::HUFFSYMB5>;
///Register HUFFSYMB5 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFSYMB5 {
    type Type = u32;
    #[inline(always)]
