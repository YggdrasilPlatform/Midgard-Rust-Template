///Reader of register HUFFMIN_4
pub type R = crate::R<u32, super::HUFFMIN_4>;
///Writer for register HUFFMIN_4
pub type W = crate::W<u32, super::HUFFMIN_4>;
///Register HUFFMIN_4 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFMIN_4 {
    type Type = u32;
    #[inline(always)]
