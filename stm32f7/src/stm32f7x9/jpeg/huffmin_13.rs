///Reader of register HUFFMIN_13
pub type R = crate::R<u32, super::HUFFMIN_13>;
///Writer for register HUFFMIN_13
pub type W = crate::W<u32, super::HUFFMIN_13>;
///Register HUFFMIN_13 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFMIN_13 {
    type Type = u32;
    #[inline(always)]
