///Reader of register HUFFENC_AC1_9
pub type R = crate::R<u32, super::HUFFENC_AC1_9>;
///Writer for register HUFFENC_AC1_9
pub type W = crate::W<u32, super::HUFFENC_AC1_9>;
///Register HUFFENC_AC1_9 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFENC_AC1_9 {
    type Type = u32;
    #[inline(always)]
