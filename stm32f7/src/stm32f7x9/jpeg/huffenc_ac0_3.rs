///Reader of register HUFFENC_AC0_3
pub type R = crate::R<u32, super::HUFFENC_AC0_3>;
///Writer for register HUFFENC_AC0_3
pub type W = crate::W<u32, super::HUFFENC_AC0_3>;
///Register HUFFENC_AC0_3 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFENC_AC0_3 {
    type Type = u32;
    #[inline(always)]
