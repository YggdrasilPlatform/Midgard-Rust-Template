///Reader of register HUFFSYMB31
pub type R = crate::R<u32, super::HUFFSYMB31>;
///Writer for register HUFFSYMB31
pub type W = crate::W<u32, super::HUFFSYMB31>;
///Register HUFFSYMB31 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFSYMB31 {
    type Type = u32;
    #[inline(always)]
