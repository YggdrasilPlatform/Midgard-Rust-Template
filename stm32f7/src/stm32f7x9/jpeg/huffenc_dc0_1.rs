///Reader of register HUFFENC_DC0_1
pub type R = crate::R<u32, super::HUFFENC_DC0_1>;
///Writer for register HUFFENC_DC0_1
pub type W = crate::W<u32, super::HUFFENC_DC0_1>;
///Register HUFFENC_DC0_1 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFENC_DC0_1 {
    type Type = u32;
    #[inline(always)]
