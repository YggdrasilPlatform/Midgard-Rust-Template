///Reader of register HUFFSYMB69
pub type R = crate::R<u32, super::HUFFSYMB69>;
///Writer for register HUFFSYMB69
pub type W = crate::W<u32, super::HUFFSYMB69>;
///Register HUFFSYMB69 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFSYMB69 {
    type Type = u32;
    #[inline(always)]
