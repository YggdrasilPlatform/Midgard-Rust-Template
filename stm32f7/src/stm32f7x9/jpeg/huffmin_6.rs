///Reader of register HUFFMIN_6
pub type R = crate::R<u32, super::HUFFMIN_6>;
///Writer for register HUFFMIN_6
pub type W = crate::W<u32, super::HUFFMIN_6>;
///Register HUFFMIN_6 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFMIN_6 {
    type Type = u32;
    #[inline(always)]
