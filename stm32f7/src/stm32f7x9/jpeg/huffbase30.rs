///Reader of register HUFFBASE30
pub type R = crate::R<u32, super::HUFFBASE30>;
///Writer for register HUFFBASE30
pub type W = crate::W<u32, super::HUFFBASE30>;
///Register HUFFBASE30 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFBASE30 {
    type Type = u32;
    #[inline(always)]
