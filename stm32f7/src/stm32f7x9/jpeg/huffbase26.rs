///Reader of register HUFFBASE26
pub type R = crate::R<u32, super::HUFFBASE26>;
///Writer for register HUFFBASE26
pub type W = crate::W<u32, super::HUFFBASE26>;
///Register HUFFBASE26 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFBASE26 {
    type Type = u32;
    #[inline(always)]
