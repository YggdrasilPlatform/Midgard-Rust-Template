///Reader of register HUFFBASE2
pub type R = crate::R<u32, super::HUFFBASE2>;
///Writer for register HUFFBASE2
pub type W = crate::W<u32, super::HUFFBASE2>;
///Register HUFFBASE2 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFBASE2 {
    type Type = u32;
    #[inline(always)]
