///Reader of register DHTMEM0
pub type R = crate::R<u32, super::DHTMEM0>;
///Writer for register DHTMEM0
pub type W = crate::W<u32, super::DHTMEM0>;
///Register DHTMEM0 `reset()`'s with value 0
impl crate::ResetValue for super::DHTMEM0 {
    type Type = u32;
    #[inline(always)]
