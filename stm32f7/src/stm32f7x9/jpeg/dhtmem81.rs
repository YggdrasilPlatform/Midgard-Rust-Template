///Reader of register DHTMEM81
pub type R = crate::R<u32, super::DHTMEM81>;
///Writer for register DHTMEM81
pub type W = crate::W<u32, super::DHTMEM81>;
///Register DHTMEM81 `reset()`'s with value 0
impl crate::ResetValue for super::DHTMEM81 {
    type Type = u32;
    #[inline(always)]
