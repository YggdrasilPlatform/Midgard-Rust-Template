///Reader of register HUFFBASE19
pub type R = crate::R<u32, super::HUFFBASE19>;
///Writer for register HUFFBASE19
pub type W = crate::W<u32, super::HUFFBASE19>;
///Register HUFFBASE19 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFBASE19 {
    type Type = u32;
    #[inline(always)]
