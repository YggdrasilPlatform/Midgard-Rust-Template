///Reader of register HUFFMIN_11
pub type R = crate::R<u32, super::HUFFMIN_11>;
///Writer for register HUFFMIN_11
pub type W = crate::W<u32, super::HUFFMIN_11>;
///Register HUFFMIN_11 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFMIN_11 {
    type Type = u32;
    #[inline(always)]
