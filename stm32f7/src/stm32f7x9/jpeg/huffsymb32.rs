///Reader of register HUFFSYMB32
pub type R = crate::R<u32, super::HUFFSYMB32>;
///Writer for register HUFFSYMB32
pub type W = crate::W<u32, super::HUFFSYMB32>;
///Register HUFFSYMB32 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFSYMB32 {
    type Type = u32;
    #[inline(always)]
