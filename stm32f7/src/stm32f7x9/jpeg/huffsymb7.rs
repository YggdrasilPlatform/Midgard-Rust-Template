///Reader of register HUFFSYMB7
pub type R = crate::R<u32, super::HUFFSYMB7>;
///Writer for register HUFFSYMB7
pub type W = crate::W<u32, super::HUFFSYMB7>;
///Register HUFFSYMB7 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFSYMB7 {
    type Type = u32;
    #[inline(always)]
