///Reader of register HUFFENC_AC0_8
pub type R = crate::R<u32, super::HUFFENC_AC0_8>;
///Writer for register HUFFENC_AC0_8
pub type W = crate::W<u32, super::HUFFENC_AC0_8>;
///Register HUFFENC_AC0_8 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFENC_AC0_8 {
    type Type = u32;
    #[inline(always)]
