///Reader of register HUFFSYMB49
pub type R = crate::R<u32, super::HUFFSYMB49>;
///Writer for register HUFFSYMB49
pub type W = crate::W<u32, super::HUFFSYMB49>;
///Register HUFFSYMB49 `reset()`'s with value 0
impl crate::ResetValue for super::HUFFSYMB49 {
    type Type = u32;
    #[inline(always)]
