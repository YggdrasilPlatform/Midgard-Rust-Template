///Reader of register OTG_FS_HPTXFSIZ
pub type R = crate::R<u32, super::OTG_FS_HPTXFSIZ>;
///Writer for register OTG_FS_HPTXFSIZ
pub type W = crate::W<u32, super::OTG_FS_HPTXFSIZ>;
///Register OTG_FS_HPTXFSIZ `reset()`'s with value 0x0200_0600
impl crate::ResetValue for super::OTG_FS_HPTXFSIZ {
    type Type = u32;
    #[inline(always)]
