///Reader of register OTG_FS_DIEPTXF3
pub type R = crate::R<u32, super::OTG_FS_DIEPTXF3>;
///Writer for register OTG_FS_DIEPTXF3
pub type W = crate::W<u32, super::OTG_FS_DIEPTXF3>;
///Register OTG_FS_DIEPTXF3 `reset()`'s with value 0x0200_0400
impl crate::ResetValue for super::OTG_FS_DIEPTXF3 {
    type Type = u32;
    #[inline(always)]
