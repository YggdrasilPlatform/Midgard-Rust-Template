///Reader of register OTG_FS_GAHBCFG
pub type R = crate::R<u32, super::OTG_FS_GAHBCFG>;
///Writer for register OTG_FS_GAHBCFG
pub type W = crate::W<u32, super::OTG_FS_GAHBCFG>;
///Register OTG_FS_GAHBCFG `reset()`'s with value 0
impl crate::ResetValue for super::OTG_FS_GAHBCFG {
    type Type = u32;
    #[inline(always)]
