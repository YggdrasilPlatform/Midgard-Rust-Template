///Reader of register OTG_FS_GUSBCFG
pub type R = crate::R<u32, super::OTG_FS_GUSBCFG>;
///Writer for register OTG_FS_GUSBCFG
pub type W = crate::W<u32, super::OTG_FS_GUSBCFG>;
///Register OTG_FS_GUSBCFG `reset()`'s with value 0x0a00
impl crate::ResetValue for super::OTG_FS_GUSBCFG {
    type Type = u32;
    #[inline(always)]
