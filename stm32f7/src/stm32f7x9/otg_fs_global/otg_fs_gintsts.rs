///Reader of register OTG_FS_GINTSTS
pub type R = crate::R<u32, super::OTG_FS_GINTSTS>;
///Writer for register OTG_FS_GINTSTS
pub type W = crate::W<u32, super::OTG_FS_GINTSTS>;
///Register OTG_FS_GINTSTS `reset()`'s with value 0x0400_0020
impl crate::ResetValue for super::OTG_FS_GINTSTS {
    type Type = u32;
    #[inline(always)]
...
///Reader of field `RSTDET`
pub type RSTDET_R = crate::R<bool, bool>;
///Write proxy for field `RSTDET`
