///Reader of register OTG_FS_GRXFSIZ
pub type R = crate::R<u32, super::OTG_FS_GRXFSIZ>;
///Writer for register OTG_FS_GRXFSIZ
pub type W = crate::W<u32, super::OTG_FS_GRXFSIZ>;
///Register OTG_FS_GRXFSIZ `reset()`'s with value 0x0200
impl crate::ResetValue for super::OTG_FS_GRXFSIZ {
    type Type = u32;
    #[inline(always)]
