///Reader of register OTG_FS_DIEPTXF5
pub type R = crate::R<u32, super::OTG_FS_DIEPTXF5>;
///Writer for register OTG_FS_DIEPTXF5
pub type W = crate::W<u32, super::OTG_FS_DIEPTXF5>;
///Register OTG_FS_DIEPTXF5 `reset()`'s with value 0x0200_0400
impl crate::ResetValue for super::OTG_FS_DIEPTXF5 {
    type Type = u32;
    #[inline(always)]
