///Reader of register OTG_FS_GINTMSK
pub type R = crate::R<u32, super::OTG_FS_GINTMSK>;
///Writer for register OTG_FS_GINTMSK
pub type W = crate::W<u32, super::OTG_FS_GINTMSK>;
///Register OTG_FS_GINTMSK `reset()`'s with value 0
impl crate::ResetValue for super::OTG_FS_GINTMSK {
    type Type = u32;
    #[inline(always)]
...
///Reader of field `RSTDETM`
pub type RSTDETM_R = crate::R<bool, bool>;
///Write proxy for field `RSTDETM`
...
///Reader of field `LPMIN`
pub type LPMIN_R = crate::R<bool, bool>;
///Write proxy for field `LPMIN`
