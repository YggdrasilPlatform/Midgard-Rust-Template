///Reader of register OTG_HS_HCDMA7
pub type R = crate::R<u32, super::OTG_HS_HCDMA7>;
///Writer for register OTG_HS_HCDMA7
pub type W = crate::W<u32, super::OTG_HS_HCDMA7>;
///Register OTG_HS_HCDMA7 `reset()`'s with value 0
impl crate::ResetValue for super::OTG_HS_HCDMA7 {
    type Type = u32;
    #[inline(always)]
