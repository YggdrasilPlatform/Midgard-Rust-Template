///Reader of register OTG_HS_HAINTMSK
pub type R = crate::R<u32, super::OTG_HS_HAINTMSK>;
///Writer for register OTG_HS_HAINTMSK
pub type W = crate::W<u32, super::OTG_HS_HAINTMSK>;
///Register OTG_HS_HAINTMSK `reset()`'s with value 0
impl crate::ResetValue for super::OTG_HS_HAINTMSK {
    type Type = u32;
    #[inline(always)]
