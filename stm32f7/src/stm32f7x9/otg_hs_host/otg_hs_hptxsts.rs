///Reader of register OTG_HS_HPTXSTS
pub type R = crate::R<u32, super::OTG_HS_HPTXSTS>;
///Writer for register OTG_HS_HPTXSTS
pub type W = crate::W<u32, super::OTG_HS_HPTXSTS>;
///Register OTG_HS_HPTXSTS `reset()`'s with value 0x0008_0100
impl crate::ResetValue for super::OTG_HS_HPTXSTS {
    type Type = u32;
    #[inline(always)]
