...
///`read()` method returns [dsi_dltcr::R](dsi_dltcr::R) reader structure
impl crate::Readable for DSI_DLTCR {}
///`write(|w| ..)` method takes [dsi_dltcr::W](dsi_dltcr::W) writer structure
...
///`read()` method returns [dsi_wpcr5::R](dsi_wpcr5::R) reader structure
impl crate::Readable for DSI_WPCR5 {}
///`write(|w| ..)` method takes [dsi_wpcr5::W](dsi_wpcr5::W) writer structure
